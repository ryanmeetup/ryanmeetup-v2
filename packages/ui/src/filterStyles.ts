const filterControlBaseClasses =
  "inline-flex items-center justify-center gap-2 rounded-lg border bg-white px-3 py-1.5 text-xs font-semibold text-black transition hover:bg-black/5 focus-visible:relative focus-visible:z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-black/30 dark:bg-white/5 dark:text-white dark:hover:bg-white/10 dark:focus-visible:ring-white/30";

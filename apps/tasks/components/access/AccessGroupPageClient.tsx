...
export function AccessGroupPageClient({
  ...
  const inheritedAccessByProject = useMemo(() => {
    ...
    const access = new Map<
      string,
      { permission: Permission; sources: string[] }
    >();
  ...
  async function updateProjectGrant(
    ...
    nextPermission: Permission | "none",
  ) {
              ...
              <Card className="p-5">
                  ...
                  {kind === "tier" && (
                    <>
                      <Input
                        ...
                        value={hierarchyRank}
                        onChange={(event) =>
                          setHierarchyRank(event.target.value)
                        }
                        disabled={saving}
                        required
                      />
                ...
                <div className="mt-5 flex flex-col gap-4 border-t border-black/10 pt-5 dark:border-white/10 sm:flex-row sm:items-center sm:justify-between">
                  <p className="text-sm text-black/70 dark:text-white/70">
                    ...
                    and project visibility changes save automatically.
                  </p>
                  <Button
                    type="submit"

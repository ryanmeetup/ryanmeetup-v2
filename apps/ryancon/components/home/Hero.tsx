        ...
        <div className='w-full'>
          <div className='grid grid-cols-12'>
            <div className='col-span-12 xl:col-span-6 space-y-4'>
              <Heading
                className='text-display2'
                size='h1'
              >
                RyanCon: the largest same name <span className='underline decoration-blue-500 underline-offset-8'>gathering of all time.</span>
              </Heading>

              <Text className='text-display3'>
                A world record breaking event organized by Ryans, for Ryans. Brought to you by the Ryan Meetup.
              </Text>
            </div>

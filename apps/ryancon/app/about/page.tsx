  ...
  return (
    <Layout fullscreen>
      ...
      <section className='relative flex min-h-[70vh] w-full items-center justify-center overflow-hidden border-b border-black/10 dark:border-white/10'>
        ...
        <div className={`relative mx-auto flex w-full max-w-6xl flex-col items-center gap-5 px-6 py-20 text-center ${layoutPaddingX}`}>
          <Pill className='bg-white/80 text-black/80 dark:bg-white/15 dark:text-white/85'>
            About Ryan Meetup
          </Pill>
          <Heading className='text-4xl sm:text-5xl lg:text-6xl title lg:whitespace-nowrap' size='h1'>
            Welcome to the Ryan Meetup.
          </Heading>

          <Text className='max-w-3xl text-lg sm:text-xl text-white/90'>
            A non-profit organization dedicated to one goal: gathering as many Ryans as possible.
          </Text>
        </div>
      </section>
